...
<head>
  ...
  <title>LS SOLUTIONS - WARSZTAT</title>
...
<body class="hold-transition layout-top-nav accent-orange dark-mode">
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white bg-navy">
    ...
    0 -100z"/>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="/" class="nav-link"><b><i class="fa fa-home"></i></b></a>
          </li>
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><b>KLIENCI</b></a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu dropdown-menu-l border-0 shadow">
              <li><a href="/lista-klientow" class="dropdown-item"><i class="fa fa-clipboard-list"></i> Lista klientów</a></li>
              <li><a href="/dodaj-klienta" class="dropdown-item"><i class="fa fa-user-plus"></i> Nowy klient</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><b>PRACOWNICY</b></a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu dropdown-menu-l border-0 shadow">
              <li><a href="#" class="dropdown-item"><i class="fa fa-clipboard-list"></i> Lista pracowników</a></li>
              <li><a href="#" class="dropdown-item"><i class="fa fa-user-plus"></i> Nowy pracownik</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><b>ZLECENIA</b></a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu dropdown-menu-l border-0 shadow">
              <li><a href="#" class="dropdown-item"><i class="fa fa-clipboard-list"></i> Moje zlecenia</a></li>
              <li><a href="#" class="dropdown-item"><i class="fa fa-clipboard-list"></i> Lista zleceń</a></li>
              <li><a href="#" class="dropdown-item"><i class="fa fa-user-plus"></i> Dodaj zlecenie</a></li>
            </ul>
          </li>
        </ul>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <!-- Kalendarz -->
            <li class="nav-item dropdown">
          <a class="nav-link" type="button" href="/kalendarz">
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          <img src="./dist/img/pawel.png" class="user-image img-circle elevation-2" alt="User Image">
          <span class="d-none d-md-inline">[IMIE] [NAZWISKO]</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="./dist/img/pawel.png" class="img-circle elevation-2" alt="User Image">
          ...
          <li class="user-footer">
            <a href="#" class="btn btn-default btn-flat"><i class="far fa-user"></i> Mój profil</a>
            <a href="#" class="btn btn-default btn-flat float-right"><i class="fa fa-sign-out-alt"></i> Wyloguj się</a>
          </li>
        </ul>
      </li>
     ...
     <!--   <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-header">Witaj [imie] [nazwisko]</span>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fa fa-cog"></i> Moje konto
            </a>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>&copy; 2023 <a href="/">LB SOLUTIONS</a></strong>
  </footer>
</div>
<!-- ./wrapper -->
