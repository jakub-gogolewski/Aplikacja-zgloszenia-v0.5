        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu dropdown-menu-l border-0 shadow">
              <li><a href="/lista-klientow" class="dropdown-item">Lista klientów</a></li>
              <li><a href="/dodaj-klienta" class="dropdown-item">Nowy klient</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu dropdown-menu-l border-0 shadow">
              <li><a href="#" class="dropdown-item">Lista pracowników</a></li>
              <li><a href="#" class="dropdown-item">Nowy pracownik</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu dropdown-menu-l border-0 shadow">
              <li><a href="#" class="dropdown-item">Moje zlecenia</a></li>
              <li><a href="#" class="dropdown-item">Lista zleceń</a></li>
              <li><a href="#" class="dropdown-item">Dodaj zlecenie</a></li>
            </ul>
          </li>
        </ul>
